...
// console.log(item)
//     const modalRef = this.modalservice.open(RemoveUserModalComponentComponent);
...
// removeUser(item: User) {
//   console.log(item)
//       // const modalRef = this.modalservice.open(RemoveUserModalComponentComponent,{data:name:item});
//       console.log(item.uid)
//       // modalRef.componentInstance.name=item;
//       console.log('return from modal')
//       // this.LoadUser();
